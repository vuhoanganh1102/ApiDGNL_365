...
exports.decrypt = async(req, res, next) => {
    // Lấy dữ liệu Base64 của ảnh từ request body hoặc query parameter
    const base64Image = req.body.base64Encoded;
    // Giải mã chuỗi Base64 thành dữ liệu ảnh gốc
    const imageBuffer = Buffer.from(base64Image, 'base64').toString();
