...
exports.saveCV = async(req, res, next) => {
    try {
        ...
        console.log(await functions.uploadAndCheckPathIMG(userId, nameImage))
        if (await functions.uploadAndCheckPathIMG(userId, nameImage) != 'EXIT') return await functions.setError(res, 'Upload ảnh thất bại', 404);
