...
exports.getCategories = async(req, res, next) => {
    try {
        ...
        cateId ? data = await DanhMucMail365.find({ cateId }) : data = await DanhMucMail365.find({});
...
exports.findByCategory = async(req, res, next) => {
    try {
        ...
        if (data.lenght) return await functions.success(res, 'Thành công', data);
...
exports.preview = async(req, res, next) => {
    try {
        ...
        await Mail365.updateOne({ _id }, { $set: { view: 0, } });
