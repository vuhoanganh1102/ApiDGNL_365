...
router.post('/getByNganh/:ca', formData.parse(), don.getByNganh);
...
router.post('/findNganhDon/', functions.checkToken, don.findNganhDon);
...
router.post('/findDon/', functions.checkToken, don.findDon);
router.post('/updateDon/', formData.parse(), functions.checkToken, don.updateDon);

// xóa mẫu Don
router.post('/deleteDon/', functions.checkToken, don.deleteDon);
