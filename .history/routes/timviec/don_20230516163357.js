...
router.post('/findDon/:_id', functions.checkToken, don.findDon);
router.post('/updateDon/:_id', formData.parse(), functions.checkToken, don.updateDon);

// xóa mẫu Don
router.post('/deleteDon/:_id', functions.checkToken, don.deleteDon);
