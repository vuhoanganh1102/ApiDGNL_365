...
router.post('/findSYLL/:_id', functions.checkToken, syll.findSYLL);
router.post('/updateSYLL/:_id', formData.parse(), functions.checkToken, syll.updateSYLL);

// xóa mẫu SYLL
router.post('/deleteSYLL/:_id', functions.checkToken, syll.deleteSYLL);
