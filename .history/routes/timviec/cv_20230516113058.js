...
// tạo mới cv
exports.post('/createCV', formData.parse(), functions.checkToken, cv.createCV);

// sửa cv
// b1. lấy dữ liệu cũ
exports.post = ('/findCV/:_id', functions.checkToken, cv.findCV);
//b2. cập nhật
exports.post = ('/updateCV/:_id', formData.parse(), functions.checkToken, cv.updateCV);

//xóa cv
exports.post = ('/deleteCV/:_id', functions.checkToken, cv.deleteCV);
