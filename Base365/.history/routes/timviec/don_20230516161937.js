...
// tạo mới mẫu Don
router.post('/createDon', formData.parse(), functions.checkToken, cv.createDon);

// sửa mẫu Don - findDon & updateDon
router.post('/findDon/:_id', functions.checkToken, cv.findDon);
router.post('/updateDon/:_id', formData.parse(), functions.checkToken, cv.updateDon);

// xóa mẫu Don
router.post('/deleteDon/:_id', functions.checkToken, cv.deleteDon);
