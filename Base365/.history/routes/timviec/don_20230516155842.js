...
// thêm mới NganhDon
router.post('/createNganhDon', formData.parse(), functions.checkToken, cv.createNganhDon);

// sửa NganhDon- findNganhDon & updateNganhDon
router.post('/findNganhDon/:_id', functions.checkToken, cv.findNganhDon);
router.post('/updateNganhDon/:_id', functions.checkToken, formData.parse(), cv.updateNganhDon);

// xóa NganhDon
router.post('/deleteNganhDon/:_id', functions.checkToken, formData.parse(), cv.deleteNganhDon);
