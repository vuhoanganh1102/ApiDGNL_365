...
router.post('/findCVGroup', functions.checkToken, formData.parse(), cv.findNganhCV);
router.post('/updateCVGroup', functions.checkToken, formData.parse(), cv.updateNganhCV);

// xóa NganhCV
router.post('/deleteCVGroup', functions.checkToken, formData.parse(), cv.deleteNganhCV);
