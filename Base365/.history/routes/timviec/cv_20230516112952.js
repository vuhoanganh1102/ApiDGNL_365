...
// sửa cv
// b1. lấy dữ liệu cũ
exports.post = ('/findCV', functions.checkToken, cv.findCV);
//b2. cập nhật
exports.post = ('/updateCV', formData.parse(), functions.checkToken, cv.updateCV);

//xóa cv
exports.post = ('/deleteCV', functions.checkToken, cv.deleteCV);
