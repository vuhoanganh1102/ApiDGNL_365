...
const NganhDon = require('../../models/Timviec365/CV/ApplicationIndustry');
...
exports.getByNganh = async(req, res, next) => {
    try {
        ...
        const data = await functions.getDataDonThu(DonXinViec, { cateId }); // tìm theo id Ngành
...
exports.saveDon = async(req, res, next) => {
    try {
        ...
        const uploadImage = await functions.uploadAndCheckPathIMG(userId, imageFile);
