...
exports.getDon = async(req, res, next) => {
    try {
        ...
        if (data.lenght) return await functions.success(res, 'Lấy mẫu DON thành công', { data });
...
exports.getByNganh = async(req, res, next) => {
    try {
        ...
        if (data.lenght) return await functions.success(res, `DON theo ngành ${cateId}`, { data });
