...
exports.saveCV = async(req, res, next) => {
    try {
        ...
        const uploadPath = `public/candidate/${userId}/${nameImage.fieldName}.jpg`; // Thay đổi 'path/to/upload/image.jpg' thành đường dẫn đích bạn muốn tải lên
        await fs.writeFile(uploadPath, imagePath);

        console.log('Tập tin đã được tải lên thành công.');
