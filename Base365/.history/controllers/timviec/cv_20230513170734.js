...
exports.saveCV = async(req, res, next) => {
    try {
        ...
        const checkAvatar = await functions.checkImage('D:\API-BASE365\API-BASE365\public\candidate\fileUpload\videoUpload1683692328681-613372636.mp4');
        console.log(checkAvatar, 1);
